...
const INITIAL_MOCK_REPORTS: IncidentReport[] = [
  {
    ...
    type: 'Harassment',
    description: 'Verbal harassment reported near library exit during evening hours.',
    ...
    authorityEncryptedIdentity: 'ENC-AUTH-TOKEN[a3RkZXZAZW1haWwuY29t]',
    collegeId: 'mu',
    collegeName: 'University of Mumbai',
    campusId: 'mu-fort',
    ...
    actionTaken: 'Security desk initiated video analysis.',
    ...
    history: [
      {
        ...
        remarks: 'Report logged via SafeRoute Mobile App',
      },
      {
        id: 'HIST-102',
  ...
  },
  {
    ...
    authorityEncryptedIdentity: 'rahul.s@example.com',
    collegeId: 'mu',
    collegeName: 'University of Mumbai',
    campusId: 'mu-kalina',
    ...
    assignedPersonOrTeam: 'Kalina Campus Squad',
    responseStatus: 'In Progress',
    responseNotes: 'Maintenance team dispatched with temporary floodlight unit.',
    actionTaken: 'Temporary LED floodlights deployed along walkway.',
    remarks: 'Field team deployed temporary battery floodlights.',
    history: [
      {
        id: 'HIST-201',
  ...
  },
  {
    ...
    isAnonymous: true,
    reporterName: 'Anonymous Citizen',
    authorityEncryptedIdentity: 'ENC-AUTH-TOKEN[aWl0Yl9zdHVkZW50QGdtYWlsLmNvbQ==]',
    collegeId: 'iitb',
